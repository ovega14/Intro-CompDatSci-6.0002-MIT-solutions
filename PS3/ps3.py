...
class RectangularRoom(object):
    ...
    def clean_tile_at_position(self, pos, capacity):
        ...
        # update dirt amount (can never be negative)
...
class Robot(object):
    ...
    def __init__(self, room, speed, capacity):
        ...
        # initialize random position and random direction
...
class FurnishedRoom(RectangularRoom):
    ...
    def is_position_valid(self, pos):
        ...
        """
        return (RectangularRoom.is_position_in_room(pos) and not self.is_position_furnished(pos))
    ...
    def get_random_position(self):
        ...
        """
        # try any random position in the room
        x_rand = random.random()*(self.width - 1)
        y_rand = random.random()*(self.height - 1)
        pos = Position(x_rand, y_rand)
        
        # generate random positions until one is not in furnished tile
