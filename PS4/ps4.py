...
def calc_pop_avg(populations, n):
    ...
    """
    # get the bacteria populations at time step n across all trials
    num_bacteria = [populations[i][n] for i in range(len(populations))]

    return sum(num_bacteria)/len(num_bacteria)
