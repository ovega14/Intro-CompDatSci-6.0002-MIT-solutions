...
#
# Answer: The objective function is to minimize the distance traveled between
# the start node and end node. The constraint is to not exceed the maximum
# distance outdoors.
